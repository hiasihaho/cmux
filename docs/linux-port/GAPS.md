...
| codex-teams / omc / omo / omx — real teammate splits | launcher+shim setup now verified (teams-siblings-smoke, batch 1); the real-split leg still needs the agent binaries (codex/omc/omx/opencode-plugin) installed to run end-to-end | teams-siblings 2026-07-23 | S |
