...
| [features/](features/) | per-feature **purpose/usage/implementation** pages; board generated by `features-board.py` (mac / dev / daily columns, ADR-0011) | author pages as features land; board self-regenerates on serve |
