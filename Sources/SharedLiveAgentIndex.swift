...
final class SharedLiveAgentIndex {
    ...
    private static let maximumForkExecutableWatchPathCountPerValidation = 32
    private static let maximumForkExecutableWatchSourceCount = 256
            ...
            if snapshot == nil {
                ...
                if let identity = AgentForkSupport.forkValidationIdentity(
                    ...
                    case "resolved":
                        ...
                        guard let generation = await updateForkExecutableWatch(
    ...
    private static func openForkExecutableWatchFileDescriptors(
        lookupPath: String,
        realPath: String,
        watchDirectories: [String]
    ) -> [Int32]? {
        ...
        watchPaths.insert(URL(fileURLWithPath: lookupPath).deletingLastPathComponent().path)
    ...
    private static func watchableDirectoryPath(forDirectoryPath path: String) -> String? {
